    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferences', models.JSONField(choices=[('SEDAN', 'sedan'), ('HATCHBACK', 'hatchback'), ('COUPE', 'coupe'), ('CABRIOLET', 'cabriolet'), ('LIMOUSINE', 'limousine')])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modification_time', models.DateTimeField(auto_now=True)),
                ('cars_quantity', models.PositiveSmallIntegerField()),
                ('car_dealership', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='car_dealerships.cardealership')),
            ],
            options={
                'abstract': False,
            },
