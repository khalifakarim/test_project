    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_time', models.DateTimeField(auto_now_add=True)),
                ('modification_time', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='promotions', to='car_dealerships.cardealership')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='regular_customers', related_query_name='regular_car_dealership', to='provider.provider')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='provider',
            name='customers',
            field=models.ManyToManyField(related_name='providers', through='provider.RegularProviderCustomer', to='car_dealerships.CarDealership'),
        ),
        migrations.CreateModel(
            name='Manufacturer',
            fields=[
